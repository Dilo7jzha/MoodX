        ...
        <div class="content-section">
            <div class="content-sidebar">
                ...
                <ul>
                    ...
                    <li><a href="#feelings-effects">Physical Activity and Routine</a></li>
                    <li><a href="#seeking-support-and-connection">Seeking Support and Connection</a></li>
                </ul>
            </div>

            <div class="content-main">
                <h2 id="mindfulness-and-self-care">Understanding stress</h2>
                <p>
                ...
                <h2 id="seeking-support-and-connection">Tips to manage stress</h2>
                <p>
